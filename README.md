# Hello AdventAI - Day 5️⃣

![Banner](repository-assets/banner.png)

[![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d5&owner=%40me&name=th-adventai-d5&description=AdventAI+Day+5+Fork&visibility=public)

## Table of Contents

- [Hello AdventAI - Day 5️⃣](#hello-adventai---day-5️⃣)
...
![Screengrab](repository-assets/career_screen.gif)

On Day 5️⃣, we are unwrapping an AI Career Coach App, a personalized platform designed to support career growth by delivering tailored daily improvement recommendations via email.

What you get:

- **Daily Email Recommendations**: Sends engaging, actionable emails with career tips, motivational advice, and curated learning resources to spark daily growth.
- **Personalized Insights**: Adapts suggestions based on your industry, role, and professional goals for maximum relevance.
- **AI-Driven Goal Setting**: Helps you define realistic career objectives and provides tailored guidance to achieve them.
- **Customizable Focus Areas**: Allows you to prioritize topics like leadership, technical skills, or personal branding, ensuring the content matches your interests.

> [!NOTE]
> This app requires the `send_email`, `memory_fetch`, and `memory_store` tools.
...
- [![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d5&owner=%40me&name=th-adventai-d5&description=AdventAI+Day+5+Fork&visibility=public)
  ...
  Or Create a [Fork](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d5&owner=%40me&name=th-project&description=AdventAI+Day+5+Fork&visibility=public)
...
```bash
git clone https://github.com/{USERNAME}/adventai-d5/
cd adventai-d5
```
...
[Back to Top ⬆️](#hello-adventai---day-5️⃣)
